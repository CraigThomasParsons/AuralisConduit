...
- Sprint2: in-progress (Task 0 and Task 1 complete on 2026-03-20)
- Sprint3: ready
- Sprint4: ready
- Sprint5: ready
...
- Sprint2 Task 1: Grok adapter implemented with MutationObserver completion detection, resilient selector flow, and `/complete` server callback compatibility.
